...
final class ConfigurationLoader
{
    public static function load(): ConfigurationSet
    {
        ...
        $rabbitMqConsumer = new RabbitMqConsumerConfig(
            ...
            self::list('RABBITMQ_CONSUMER_BINDINGS', 'integration.transport.#,space.catalog.item.observed,space.purchase_order.#,marketplace.order.observed,marketplace.offer.#'),
