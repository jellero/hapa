    ...
    private function navigation(): array
    {
        return [
            ['label' => 'Operatività', 'items' => [
                ...
                ['label' => 'Prodotti', 'href' => '/ui/products', 'icon' => 'box', 'active' => 'products'],
                ['label' => 'Fornitori Space', 'href' => '/ui/suppliers', 'icon' => 'integration', 'active' => 'suppliers'],
                ['label' => 'Cataloghi e prezzi', 'href' => '/ui/catalog', 'icon' => 'settings', 'active' => 'catalog'],
