...
<div class="dashboard-grid">
    ...
    <section class="panel panel--span-3" aria-labelledby="exceptions-title">
        ...
        <div class="workstream-list">
            <a class="workstream-item" href="/ui/audit?level=error&amp;entity_type=inbox_message"><span class="workstream-item__icon"><svg class="icon"><use href="/assets/icons.svg#inbox"></use></svg></span><div class="workstream-item__copy"><strong>Inbox fallite</strong><span>Lag più vecchio: <?= $e((string) ($runtime['lag_seconds']['inbox_failed_oldest'] ?? 0)) ?> secondi</span></div><span class="status-badge status-badge--<?= ($runtime['inbox']['failed'] ?? 0) > 0 ? 'danger' : 'success' ?>"><?= $e((string) ($runtime['inbox']['failed'] ?? 0)) ?></span></a>
